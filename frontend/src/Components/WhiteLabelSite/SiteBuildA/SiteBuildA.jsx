        ...
        <div className="siteBuildFormA">
          ...
          <form action="">
            <div className="siteBuildFormLabelA">
              <label htmlFor="contact_name">Contact Name<span style={{ color: 'red' }}>*</span></label>
            </div>
            <input type="text"
              id="contact_name"
              name="contact_name"
            ...
            <div className="siteBuildFormLabelA">
              ...
              <p>Users of your stand-alone site who click on your logo will be directed to this URL</p>
            </div>
            <input type="text"
              id="home_link"
              name="home_link"
