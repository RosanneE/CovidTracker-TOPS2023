...
export default function ReqQuestion1(props) {
 return ( 
    <>
...
<button className="positiveNegative dissolveEffect"><img src={tissue} alt="Happy face" style={{maxWidth:"100%", width:"2rem"}}/> Positive</button> 
<button className="positiveNegative dissolveEffect"><img src={happy} alt="Happy face" style={{maxWidth:"100%", width:"2rem"}}/> Negative</button><br/>
